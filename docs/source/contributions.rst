...
**Shengyuan Lin** (shengyu3@andrew.cmu.edu): Project lead of OpenFinLLM Leaderboard. Contributed majority of overview, descriptions, and overall project framing. Project vision, documentation structure, and strategic direction. Main maintainer of the `OpenFinLLM Leaderboard <https://huggingface.co/spaces/finosfoundation/Open-Financial-LLM-Leaderboard>`_ HuggingFace repository.
